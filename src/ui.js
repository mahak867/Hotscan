...
export function shareCollection() {
  ...
  var txt = ['🚗 My HotScan India Collection','','📦 ' + total + ' cars · ₹' + val.toLocaleString('en-IN') + ' total value', sth > 0 ? '⭐ ' + sth + ' Super Treasure Hunt' + (sth>1?'s':'') : '','','📷 Track yours free at hotscan.in'].filter(Boolean).join('\n')
